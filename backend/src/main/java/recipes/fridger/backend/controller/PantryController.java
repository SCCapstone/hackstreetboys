...
//    public ResponseEntity<String> deletePantry(@PathVariable Long id) {
//        try {
...
//    public @ResponseBody Pantry getPantry(@PathVariable Long id) {
//        return pantryService.getPantryByID(id);
//    }
//    @GetMapping(path = "/")
//    public @ResponseBody Iterable<Pantry> getPantries(@RequestParam(required = false) Long id) {
//        return pantryService.getPantries(id);
//    }
//}
